...
To start the client make sure port 3002 is unblocked.
From client directory run:
npm start

To start the client and have it run in the background:
nohup npm start &

you may need to use pgrep npm to get the PID and kill the process with:
kill [PID]
